package com.putyourz.mynoteapp;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveFile() {
        if (editTitle.getText().toString().isEmpty()) {
            Toast.makeText(this, "Title harus diisi cyyn", Toast.LENGTH_SHORT).show();
        } else if (editContent.getText().toString().isEmpty()) {
            Toast.makeText(this, "ini juga di isi cyyn xD", Toast.LENGTH_SHORT).show();
        }  else {
